...
class DataGenerator {
     ...
     *
     * @param tempFileNamePrefix The prefix string to be used in generating the
     *                           file's name.
     * @param tempFileNameSuffix The suffix string to be used in generating the
     *                           file's name.
     * @param bytesToWrite       The number of bytes to write to file.
     * @return The newly created File object
     */
    static File createTempLocalFile(String tempFileNamePrefix, String tempFileNameSuffix, int bytesToWrite)
            throws IOException {
